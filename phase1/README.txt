...
--------------------------------------------------
HOW IT WORKS:
1. Run the program, a screen will be displayed with the question asking if you have an account or not; if you click on "YES", you will be directed to the log-in screen where you can log in with username as "username" and password as "password"; if you click on "NO", you will be directed to a "New Feature is Coming" screen showing a message that you can create an account in phase 2, with a possible extension featured designed in the Menus.java class;
