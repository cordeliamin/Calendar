...
//        submit.setBounds(200, 200, 90, 30);
    ...
    public void createMemoDisplay(String user, Calendar myCalendar, JFrame f) {
        ...
        submit.addActionListener(ae -> {
            ...
            if (eventList.length != 0) {
                ...
                if (eventsInCalendar(eventList, myCalendar)) { // checks if the events entered are in the initialBuild.Calendar
                ...
                if (eventsInCalendar(newEventsList, myCalendar)) { // checks if the events entered are in the initialBuild.Calendar
    ...
    // returns a boolean value for whether a given array of events are in the initialBuild.Calendar or not
